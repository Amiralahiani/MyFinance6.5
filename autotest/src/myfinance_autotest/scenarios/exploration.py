...
def exploration_charters() -> list[TestCase]:
    ...
    return [
        ...
        _charter("CONFLICTING-BANKS", "Explicit two-bank comparison", "What was the net banking income of BIAT and Amen Bank in 2025?", category=TestCategory.CONVERSATION, expected_properties=["response_type:comparison"]),
